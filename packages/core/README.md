...
Complete, runnable examples live in [`examples/`](https://github.com/evgkch/machjs/tree/master/examples) of this repository and are hosted at [evgkch.github.io/machjs](https://evgkch.github.io/machjs/).
...
The `packages/core/scripts/render.ts` script (not included in the package; run from `packages/core`):
